...
public class MessageConstant {
    ...
    public static final String CHECKITEM_IS_QUOTED = "当前检查项被引用，不能删除";
    public static final String CHECKGROUP_IS_QUOTED = "当前检查组被引用，不能删除";
    ...
    public static final String QUERY_ORDERSETTING_SUCCESS = "获取预约设置数据成功";
    public static final String QUERY_ORDERSETTING_FAIL = "获取预约设置数据失败";
    public static final String EDIT_ORDERSETTING_SUCCESS = "预约设置成功";
    public static final String EDIT_ORDERSETTING_FAIL = "预约设置失败";
    ...
    public static final String ADD_ORDER_SUCCESS = "预约成功";
    public static final String ADD_ORDER_FAIL = "预约失败";
